...
$url        = 'https://developer.salesforce.com/media/salesforce-cli/sfdx-windows-386.exe' # download url, HTTPS preferred
$url64      = 'https://developer.salesforce.com/media/salesforce-cli/sfdx-windows-amd64.exe' # 64bit URL here (HTTPS preferred) or remove - if installer contains both (very rare), use $url
...
$packageArgs = @{
  ...
  softwareName  = 'sfdx*' #part or all of the Display Name as you see it in Programs and Features. It should be enough to be unique
